...
public:
		...
		void setAll(string sensors);

        string toString();

		/* Image saver and getter methods */

		void createImage(int width, int height);

		void releaseImage();

		void saveImage(const char camID, const unsigned char *imgBuf, int width, int height);

        IplImage* getForesightImg();

		IplImage* getBacksightImg();
